...
import { Plus, Upload, Download, Save, Trash2, Edit3, FolderOpen, Copy, Edit2, Database } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                disabled={isSaving}
                className="px-3 py-1.5 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-200 font-dm-sans text-sm disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={isLoading}
                className="px-3 py-1.5 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-all duration-200 font-dm-sans text-sm disabled:opacity-50"
              >
              ...
              <button className="px-3 py-1.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all duration-200 font-dm-sans text-sm">
