...
export declare type FormulaDependency = {
    row: [number, number];
    column: [number, number];
    sheetId: string | undefined;
};
declare type AncestorFormulaCell = {
    [rxcxix: string]: number;
};
export declare type FormulaCellInfo = {
...
export declare type FormulaCellInfoMap = {
    [rxcxix: string]: FormulaCellInfo;
};
export declare type FormulaCell = {
    r: number;
    c: number;
    id: string;
